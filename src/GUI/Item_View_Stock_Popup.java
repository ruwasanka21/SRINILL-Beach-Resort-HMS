...
public class Item_View_Stock_Popup extends javax.swing.JFrame {
    
    private Item_Stock_Entry stock_tb_load;

    public Item_View_Stock_Popup(Item_Stock_Entry stock_tb_load, String billNo) {
        this.stock_tb_load = stock_tb_load;
        initComponents();
    ...
    public void btnView(String billNo) {
        try {
            Statement s =  DatabaseLayer.mycon().createStatement();
            ResultSet rs = s.executeQuery("SELECT * FROM suporders WHERE billNo = '"+billNo+"'");
            ...
            if (rs.next()) {
                ...
                txtTotalBill.setText(rs.getString("Total"));
                String paidStatus = rs.getString("paidStatus");
                if ("Paid".equalsIgnoreCase(paidStatus)) {
                    radioPaid.setSelected(true);
                } else if ("Unpaid".equalsIgnoreCase(paidStatus)) {
                    radioUnpaid.setSelected(true);
                }
                ComboMethod.setSelectedItem(rs.getString("method"));
                txtPaid.setText(rs.getString("paid"));
                txtBalance.setText(rs.getString("balance"));
                expireDate.setDate(rs.getDate("ExpireDate"));
            }
    ...
    public void itemLoad(String selectedItem) {
        try {
            DefaultComboBoxModel<String> com = new DefaultComboBoxModel<>();
            com.addElement("-- Select --");
            ...
            try (Statement s = DatabaseLayer.mycon().createStatement();
                ...
                while (rs.next()) {
                    com.addElement(rs.getString("itemName"));
                }
            }
            ComboItemName.setModel(com);
            if (selectedItem != null) {
                ComboItemName.setSelectedItem(selectedItem);
                lblName.setText(selectedItem);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Database error: " + e.getMessage(),"Error", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
    ...
    private void initComponents() {
        ...
        btnSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/img/update.png"))); // NOI18N
        ...
        btnReset.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/img/delete.png"))); // NOI18N
        ...
        lblName.setFont(new java.awt.Font("Dialog", 1, 22)); // NOI18N
        lblName.setForeground(new java.awt.Color(255, 255, 255));
        lblName.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblName.setText("New Stock");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblName, javax.swing.GroupLayout.DEFAULT_SIZE, 848, Short.MAX_VALUE)
                .addContainerGap())
        );
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(expireDate, javax.swing.GroupLayout.PREFERRED_SIZE, 248, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        try {
            Statement s =  DatabaseLayer.mycon().createStatement();
            s.executeUpdate("UPDATE suporders SET itemName = '"+itemName+"', itemID = '"+itemID+"', Category = '"+supCategory+"', supName = '"+supName+"', qty = '"+qty+"', itemPrice = '"+price+"', description = '"+des+"', Total = '"+total+"', paidStatus = '"+paidStatus+"', method = '"+method+"', paid = '"+paid+"', ExpireDate = '"+expiredate+"', balance = '"+balance+"' WHERE billNo = '"+billno+"'");
            JOptionPane.showMessageDialog(null, "Stock updated successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
            stock_tb_load.tb_load();
            this.dispose();
    ...
    private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetActionPerformed
        ...
        if (response == JOptionPane.YES_OPTION) {
            String itemID = txtBillNo.getText().trim();
            try {
                Statement s =  DatabaseLayer.mycon().createStatement();
                s.executeUpdate("DELETE FROM suporders WHERE billNo = '"+itemID+"'");
                stock_tb_load.tb_load();
                this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Item_View_Stock_Popup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Item_View_Stock_Popup(null,null).setVisible(true);
            }
        });
    }
