...
public class Finance_Income_Select_Popup extends javax.swing.JFrame {
    
     private Finance income_tb_load;

    public Finance_Income_Select_Popup(Finance income_tb_load, String ID) {
    ...
    public void btnView(String ID) {
        try {
            Statement s =  DatabaseLayer.mycon().createStatement();
            ResultSet rs = s.executeQuery("SELECT * FROM income WHERE ID = '"+ID+"'");
            
            if (rs.next()) {
                txtItemID.setText(rs.getString("ID"));
                txtItemName.setText(rs.getString("Name"));
                txtDes.setText(rs.getString("Des"));
                txtLKR.setText(rs.getString("LKR"));
            }
        } catch (Exception e) {
    ...
    public void ID_retrive() {
        try {
            Statement s = DatabaseLayer.mycon().createStatement();
            String selectQuery = "SELECT ID FROM income ORDER BY ID DESC LIMIT 1";
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        try {
            Statement s =  DatabaseLayer.mycon().createStatement();
            s.executeUpdate("UPDATE income SET ID = '"+itemID+"', Name = '"+itemName+"', Des = '"+des+"', LKR = '"+lkr+"' WHERE ID = '"+itemID+"'");
            JOptionPane.showMessageDialog(null, "Item updated successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
            income_tb_load.tb_load();
            this.dispose();
    ...
    private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetActionPerformed
        ...
        if (response == JOptionPane.YES_OPTION) {
            ...
            try {
                Statement s =  DatabaseLayer.mycon().createStatement();
                s.executeUpdate("DELETE FROM income WHERE ID = '"+itemID+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Finance_Income_Select_Popup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Finance_Income_Select_Popup(null,null).setVisible(true);
            }
        });
    }
