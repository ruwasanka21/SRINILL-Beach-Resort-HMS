...
public class Finance_Income_Add_Popup extends javax.swing.JFrame {
    
     private Finance income_tb_load;

    public Finance_Income_Add_Popup(Finance income_tb_load) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Add Transaction to Income");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        try {
            Statement s = DatabaseLayer.mycon().createStatement();
            String insertQuery = "INSERT INTO income (Name, LKR, Des, Date) VALUES ('" + itemName + "', '" + lkr + "', '" + des + "', '" + addedDate + "')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Finance_Income_Add_Popup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Finance_Income_Add_Popup(null).setVisible(true);
            }
        });
    }
