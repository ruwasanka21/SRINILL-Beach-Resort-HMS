...
public class Finance_Expense_Select_Popup extends javax.swing.JFrame {
    
     private Finance income_tb_load;

    public Finance_Expense_Select_Popup(Finance income_tb_load, String ID) {
    ...
    public void btnView(String ID) {
        try {
            ...
            ResultSet rs = s.executeQuery("SELECT * FROM expense WHERE ID = '"+ID+"'");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        try {
            Statement s =  DatabaseLayer.mycon().createStatement();
            s.executeUpdate("UPDATE expense SET ID = '"+itemID+"', Name = '"+itemName+"', Des = '"+des+"', LKR = '"+lkr+"' WHERE ID = '"+itemID+"'");
    ...
    private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetActionPerformed
        ...
        if (response == JOptionPane.YES_OPTION) {
            ...
            try {
                Statement s =  DatabaseLayer.mycon().createStatement();
                s.executeUpdate("DELETE FROM expense WHERE ID = '"+itemID+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Finance_Expense_Select_Popup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Finance_Expense_Select_Popup(null,null).setVisible(true);
            }
        });
    }
